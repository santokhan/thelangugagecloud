      ...
      <main className="overflow-hidden text-gray-700 bg-white py-[5rem]">
        <section class="bg-white ">
          <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <h2 class="mb-8 text-4xl tracking-tight font-bold text-gray-900 ">
            ...
            <div class="grid pt-8 text-left border-t border-gray-200 md:gap-16  md:grid-cols-2">
              <div>
                ...
                <div class="mb-10">
                  ...
                  <p class="text-gray-500 ">
                    Feel free to contact us and we&apos;ll help you out as soon
                    as we can.
                  </p>
                </div>
                <div class="mb-10">
                  ...
                  <p class="text-gray-500 ">
                    ...
                    whether it&apos;s a personal website, a SaaS app, or a
                    website for a client. As long as you don&apos;t build a
              ...
              <div>
                <div class="mb-10">
                  ...
                  <p class="text-gray-500 ">
                    ...
                    roadmap that we have laid out for this project. It is also
                ...
                <div class="mb-10">
                  ...
                  <p class="text-gray-500 ">
                    ...
                    guidelines, component variants, and a dashboard page with
